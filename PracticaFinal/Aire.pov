...
//Aire_main.ini (initialization file - open this to render)
//Aire.pov (scene setup of cameras, lights and geometry)
//Aire_geom.inc (geometry)
//Aire_mat.inc (materials)
// 
//==================================================
//Model Statistics:
...
#include "Aire_geom.inc" //Geometry
...
camera {
        ...
        rotate <0,0,0.94584962714996> //roll
        rotate <-2.55246363384844,0,0> //pitch
        rotate <0,-11.7758448007086,0> //yaw
...
light_source {
              ...
              point_at <0,0,0>
              rotate <0,0,0.94584962714996> //roll
              rotate <-2.55246363384844,0,0> //elevation
              rotate <0,-11.7758448007086,0> //rotation
             }
 
//Background
background { color srgb <1,1,1>  }
 
//Assembled object that is contained in Aire_geom.inc with no SSLT components
object{
      Conditioner_Mitsubishi_S_N240412_
      }
